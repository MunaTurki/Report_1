    ...
    <section id="home"
     ...
     <div className="relative  flex  flex-col justify-center items-center w-full p-10" >
      ...
      In a country divided economically and politically, with a growing number of conflicts. 
        ...
        Today, they can afford only one under IRG control and less than four under Houthi control for the same price, 
      ...
      <p>
      <i>This draft report has been created by Muna Turki as a work sample to apply for DW data journalism position. For all files necessary to create this material, please visit the following Github repository:  <a href="https://github.com/MunaTurki/Report_1" target="_blank" rel="noopener noreferrer" className='text-gray-800 underline'>https://github.com/MunaTurki/Report_1</a></i>
      </p>
